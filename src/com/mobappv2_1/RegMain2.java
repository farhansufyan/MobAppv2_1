...
public class RegMain2 extends Activity implements OnClickListener{
...
//	String serverip = "http://192.168.12.97:80/android_connect/";
	String serverip = "http://54.69.110.134:80/android_connect/"; // For AWS cloud
	...
	public void onClick(View v) {
		...
		case R.id.savebtn:
			...
			break;
		case R.id.runbtn:
			Intent intent = new Intent (RegMain2.this, UploadFile2.class);
			
			// Change start here for any file path for device
